        ...
        <div class="row mt-2">
            ...
            <div class="mb-2">
                ...
                <button type="button" class="btn btn-primary btn-kuning">
                    <?php
                    $conn = open_db();
                    $sql = "SELECT SUM(jumlah) AS total FROM pengeluaran WHERE status='aktif'";
                    $retval = $conn->query($sql);
                    $data = $retval->fetch_array(MYSQLI_ASSOC);
                    $total = $data['total'];
                    $total = number_format($total);
                    echo "Total Kas Keluar = Rp. ".$total;
                    ?>
                </button>
            </div>
            <div class="mb-1">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Kas Keluar</h5>
                ...
                <form action="process.php" method="POST" class="needs-validation" novalidate>
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="jenis" required>
                            ...
                            <option value="1">Pembangunan/Renovasi Masjid</option>
                            <option value="2">Operasional Masjid</option>
                            <option value="3">Santunan</option>
                        </select>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary" name="simpan_kas_keluar">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
